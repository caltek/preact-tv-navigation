...
const getRawStartAndEndIndexes = ({
  ...
  switch (scrollBehavior) {
    ...
    case 'center':
      // Keep item centered - equal space on both sides
      const halfVisible = Math.floor(numberOfItemsVisibleOnScreen / 2);
      return {
        rawStartIndex: currentlyFocusedItemIndex - halfVisible - halfNumberOfItemsNotVisible,
        rawEndIndex: currentlyFocusedItemIndex + halfVisible + halfNumberOfItemsNotVisible,
      };
    default:
